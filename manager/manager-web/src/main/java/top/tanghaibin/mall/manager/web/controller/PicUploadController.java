...
import top.tanghaibin.mall.manager.web.bean.PicUploadResult;
...
public class PicUploadController {
	...
	private String getFilePath(String sourceFileName) {
		...
		// 生成新的文件名
		String fileName = new DateTime(nowDate).toString("yyyyMMddhhmmssSSSS") + RandomUtils.nextInt(new Random(), 9999) + "." + StringUtils.substringAfterLast(sourceFileName, ".");
